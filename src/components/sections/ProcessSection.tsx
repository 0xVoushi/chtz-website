      ...
      <div className="mx-auto max-w-[125.4rem] px-[1.6rem] lg:px-[4.8rem]">
        ...
        <div className="mt-[6.4rem]">
          <div className="grid grid-cols-1 md:grid-cols-4 relative">
            ...
            <div
              className="hidden md:block absolute top-[2.4rem] left-[12.5%] right-[12.5%] h-px border-t border-dashed border-border-light"
              aria-hidden="true"
            />
            {PROCESS.steps.map((step) => (
              <div
                key={step.number}
                className="relative px-[2.4rem] pt-[2.4rem] pb-[2rem] md:pb-0 border-t-[2px] border-orange-cta"
              >
                <span
                  className="block text-[3rem] font-semibold leading-none mb-[1.6rem] text-orange-cta"
